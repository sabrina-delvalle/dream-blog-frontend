    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data === "invalid user or password") {
          ...
          localStorage.setItem("confirmed", res.data.user.confirmed)
  ...
  return (
    <div className="centerForm-login-section">
      <form onSubmit={handleSubmit} className="centerForm-login">
        ...
        <label className="blocks-login" name="username">
          {" "}
          Username{" "}
        </label>
        <input
          ...
          className="input-1-log"
          name="username"
        />
        <label className="blocks-login" name="password">
          {" "}
          Password{" "}
        </label>
        <input
      ...
      <div>
        <p style={{ color: "#86959a" }} className="ssrr-separator">
          OR
        </p>
